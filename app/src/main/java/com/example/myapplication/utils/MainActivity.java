...
public class MainActivity extends AppCompatActivity {
    ...
    private void redirectToNextScreen() {
        com.example.myapplication.utils.GroupListActivity.start(this);
    }

    private void initCometChat(){
        CometChat.init(this, Constants.APP_ID, Constants.REGION, new CometChat.CallbackListener<String>() {
            @Override
